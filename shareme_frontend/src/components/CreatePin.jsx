                            ...
                            <label>
                                <div className="flex flex-col items-center justify-center h-full">
                                    ...
                                    <p className="mt-32 text-gray-400">
                                        Recommendation: use hight-quality JPG, SVG, PNG, GIF or TIFF less than 20 MB
                                    </p>
                                </div>
                                <input 
                                    type="file"
                    ...
                    <div className="flex flex-col">
                        <div>
                            ...
                            <select
                                ...
                                className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounde-md cursor-pointer"
                            >
